                    ...
                    <v-card width="550px" height="300px" variant="flat">
                        <v-row class="align-content-center">
                            ...
                            <v-col cols="4">
                                ...
                                <v-card-subtitle>{{ provide.organitation }}</v-card-subtitle>
...
const categories = ref([
  ...
  const items = ref([
    ...
    { id: 7, name: '褲子', organitation:'台北市社會局', number:3, category: '服飾配件' },
    { id: 8, name: '洗髮精', organitation:'新北市社會局', number:10, category: '日用品' }
    // 添加其他物品
  ]);
